...
import { OMNIDEF } from './demoOSDemoOSEnglish_def.js';
import tmpl from './demoOSDemoOSEnglish.html';
import tmpl_nds from './demoOSDemoOSEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class demoOSDemoOSEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;

...
import { OMNIDEF } from './accountOSEnglish_def.js';
import tmpl from './accountOSEnglish.html';
import tmpl_nds from './accountOSEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class accountOSEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;

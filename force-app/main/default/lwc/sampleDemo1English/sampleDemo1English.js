...
import { OMNIDEF } from './sampleDemo1English_def.js';
import tmpl from './sampleDemo1English.html';
import tmpl_nds from './sampleDemo1English_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class sampleDemo1English extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;

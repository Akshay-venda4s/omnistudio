...
import { OMNIDEF } from './demoEditBlockEnglish_def.js';
import tmpl from './demoEditBlockEnglish.html';
import tmpl_nds from './demoEditBlockEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class demoEditBlockEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
